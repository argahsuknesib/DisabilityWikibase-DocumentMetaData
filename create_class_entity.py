...
class CreateClass:
    ...
    def create_entity(self):
        ...
        dis_wiki_data = {
            ...
            'aliases': {
                'en': ['Diswiki', 'disability wiki', 'wiki disability', 'wiki rights', 'disability wiki rights',
                       'diswikidata'],
                'fr': ['Diswiki', 'disability wiki', 'wiki disability', 'wiki rights', 'disability wiki rights',
                       'diswikidata']}}
        ...
        doc_data = {'labels': {'en': 'Document', 'fr': 'Document'},
                    'descriptions': {'en': 'preserved information',
                                     'fr': "porteur d'information qui contient l'écriture"},
                    'aliases': {'en': ['doc', 'record', 'documents', 'docs', 'records'],
                                'fr': ["pièce d'archives", "documents", "pièces d'archives"]}}
        ...
        crpd_data = {'labels': {'en': 'CRPD', 'fr': 'CRPD'},
                     'descriptions': {'en': 'Convention on the Rights of Persons with Disabilities',
                                      'fr': "Convention sur les droits des personnes handicapées"},
        ...
        web_content_data = {'labels': {'en': 'Web content', 'fr': 'Contenu du web'},
                            ...
                            'aliases': {'en': ['blog', 'website', 'blog post', 'online resource'],
                                        'fr': ["blog", "site web"]}}
        web_content_class.editEntity(web_content_data, summary='Edit web content')

        topic_class = pywikibot.ItemPage(self.wikibase_repo)
        topic_data = {'labels': {'en': 'Topic', 'fr': 'Thème'},
                      'descriptions': {'en': 'in linguistics, the known information in a phrase',
                                       'fr': "l'information connue dans une phrase"},
                      'aliases': {
                          'en': ['Subject', 'Topics', 'topic', 'tags', 'tag', 'theeme', 'sub topic', 'sub topics'],
        ...
        paragraph_data = {'labels': {'en': 'Paragraph', 'fr': 'Paragraphe'},
                          'descriptions': {'en': 'portion of text composed of one or more sentences',
                                           'fr': "partie dans le texte est composé d'un ou plusieurs jeux"},
        ...
        has_paragraph_property_data = {'labels': {'en': 'has paragraph', 'fr': "a un paragraphe"},
                                       'descriptions': {'en': 'paragraph of the document',
                                                        'fr': "paragraphe du document"},
